...
const UserPanel = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const { data, error } = await supabase.rpc("search_transaction", {
        t_id: searchId,
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          `Edge Function error: ${response.status} ${response.statusText} - ${errorText}`,
        );
      }
        ...
        {!submitted ? (
          <div className="mb-5">
            <form id="transaction-form" onSubmit={handleSubmit}>
              <div className="mb-4">
                <label htmlFor="phone-number" className="block mb-1 font-bold">
                  Phone Number
                </label>
                <input
                  type="tel"
              ...
              <div className="mb-4">
                <label htmlFor="network" className="block mb-1 font-bold">
                  Network
                </label>
                <select
                  id="network"
              ...
              {paymentDetails && (
                <div id="payment-details" className="mb-4">
                  {paymentDetails}
                </div>
              )}
              <div className="mb-4">
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center">
                  <label
                    htmlFor="receipt"
                    className="cursor-pointer bg-gray-500 text-white py-2 px-4 rounded hover:bg-gray-600 transition-colors"
                  >
                    Upload Files
                  </label>
                  <input
